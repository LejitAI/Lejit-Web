...
const Sidebar = () => {
  ...
  const menuItems = [
    { text: "Dashboard", icon: <DashboardIcon />, path: "/cdashboard" },
    ...
    },
    {
      ...
      icon: <ArticleIcon />,
      path: "/citizentemplates",
    },
    { text: "Knowledge Hub", icon: <BookIcon />, path: "/citizenknowledge" },
    {
      text: "Notification",
      icon: <NotificationsIcon />,
      path: "/citizennotification",
    },
    {
      text: "Analytics/Reports",
      icon: <BarChartIcon />,
      path: "/citizenanalytics",
    },
